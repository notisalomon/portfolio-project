...
const Experience = () => {
  const timeline = [
    ...
    },
    {
      ...
      organization: 'Fernfachhochschule Schweiz',
      period: 'Aktuell',
    ...
    },
    {
      icon: <Briefcase className="text-cyan-400" size={24} />,
      type: 'work',
      title: 'Freelance Webapp Entwicklung',
      organization: 'Selbstständig',
      period: '2016 - Heute',
      description: 'Entwicklung von modernen Web-Anwendungen und Lösungen für verschiedene Kunden.',
    },
    {
      icon: <GraduationCap className="text-cyan-400" size={24} />,
      type: 'education',
      title: 'Wirtschaftsinformatik (HF)',
      organization: 'AKAD Technics',
      period: '2018 - 2021',
